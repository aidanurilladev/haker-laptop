        ...
        <div className={s.mainCharacter}>
          ...
          <div className={s.detailPageAccessoryText}>
            ...
            <p>
              ...
              компьютеров. Манипулятор оборудован оптическим светодиодным
              сенсором HERO, демонстрирующим значительное разрешение. Высокая
              точность позиционирования помогает достигать успеха в динамичных
              видеоиграх.
            </p>
